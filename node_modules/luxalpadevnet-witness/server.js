"use strict";
require("luxalpacore/wallet.js");
const witness = require('luxalpa-witness');
const explorer = require('luxalpa-explorer/explorer.js');
const headlessWallet = require('luxalpa-headless');
const eventBus = require('luxalpacore/event_bus.js');
const validationUtils = require("luxalpacore/validation_utils.js");
const conf = require('luxalpacore/conf.js');
const constants = require('luxalpacore/constants.js');
...
function createIndivisibleAssetPayment(asset, amount, fromAddress, toAddress, toDevice, callback) {
	...
	var indivisibleAsset = require('luxalpacore/indivisible_asset.js');
...
eventBus.on('paired', function(from_address) {
    ...
    const device = require('luxalpacore/device.js');
