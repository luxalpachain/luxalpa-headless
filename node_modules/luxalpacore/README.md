...
This is a library used in [Luxalpa](https://luxalpa.org) clients.  Never used directly.  Some of the clients that require the library:

* [Luxalpa](../../../luxalpa) - GUI wallet for Mac, Windows, Linux, iOS, and Android.
* [Headless Luxalpa](../../../Luxalpa-headless) - headless wallet, primarily for server side use.
...
See the [wiki](https://github.com/luxalpa/luxalpacore/wiki/Luxalpa-Developer-Guides).  Many of the features are not documented yet, see other [luxalpa repositories](https://github.com/luxalpa) as samples, for APIs see the `exports` of node.js modules.
