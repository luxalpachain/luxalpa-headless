...
function validateMessage(conn, objMessage, message_index, objUnit, objValidationState, callback) {
	// 修复历史unit的bug： output金额有小数，从而在验证的时候没有问题但是入库自动去掉了小数部分，导致其他节点同步和验证的时候出现验证问题。
	if (objUnit.unit === 'ahkLLcPv1JF/rFF+RViPdUvXSn3Yz6N4W2zf997YGEE=') {
		objMessage.payload.outputs[0].amount = (objMessage.payload.outputs[0].address === 'BFFJB73G4MTMTW5KJHXGAW3NRW2YQONW') ? 123453.5123251 : 9875546.4876749;
		objMessage.payload.outputs[1].amount = (objMessage.payload.outputs[1].address === 'BFFJB73G4MTMTW5KJHXGAW3NRW2YQONW') ? 123453.5123251 : 9875546.4876749;
	}
	if (objUnit.unit === '/asoiGJgtl7pqTekqGo97HAT+2fQm5vXmYXVOzQwnys=') {
		objMessage.payload.outputs[0].amount = (objMessage.payload.outputs[0].address === 'BFFJB73G4MTMTW5KJHXGAW3NRW2YQONW') ? 123453.5123251 : 4862816.4876749;
		objMessage.payload.outputs[1].amount = (objMessage.payload.outputs[1].address === 'BFFJB73G4MTMTW5KJHXGAW3NRW2YQONW') ? 123453.5123251 : 4862816.4876749;
	}
